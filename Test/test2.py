...
for v in vertexes:
    for d in density:
        for i in range(iterations):
            ...
            command_seq = os.path.join(current_directory, 'Build', 'Sequential_prim2.exe')
            ...
            while omp <= omp_max:
                ...
                command_cuda = os.path.join(current_directory, 'Build', 'CUDA_prim2.exe')
                ...
                while mpi <= mpi_max and (omp * mpi) < 12:
                    ...
                    command_mpi = os.path.join(current_directory, 'Build', 'MPI_OMP_prim2.exe')
...
print(f"Test 2: {total_time_minutes:.2f} minuti")